                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        if (isset($_GET['id'])) {
                                            ...
                                            $result = $produitC->findById($_GET['id']);
                                            ...
                                            foreach ($result as $row) {
                                                ...
                                                $etat = $row['etat'];
                                                $dateFabrication = $row['dateFabrication'];
                                                $prix = $row['prix'];
                                        ...
                                        <table>
                                            <form action="post_mdProduit.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <tr>
                                                    <td>
                                                        <label style="font-weight: bold"> etat </label>
                                                        <input type="text" class="form-control" name="etat" placeholder="" required="" value="<?php echo $etat ?>" style="width:500px">
                                                        </br>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label style="font-weight: bold"> date de fabrication </label>
                                                        <input type="text" class="form-control" name="dateFabrication" placeholder="" required="" value="<?php echo $dateFabrication?>" style="width:500px">
                                                        </br>
                                                    </td>
                                                </tr>
                                                   <tr>
                                                    <td>
                                                        ...
                                                        <input type="text" class="form-control" name="prix" placeholder="" required="" value="<?php echo $prix?>" style="width:500px">
                                                        </br>
                                                    </td>
                                                </tr>
