    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-4">
                <h4 class="page-title" style="text-align: center"><u> Recherche Produits</u></h4>
            </div>
            ...
            <div class="col-sm-4 col-5">
                ...
                <form action="" method = 'POST'>
                        <div class="col-80">
                            <input type = "text" name = "type" class="form-control" placeholder="entrer le nom du produit">
                        </div>
                    ...
                    <tr>
                        <td><?= $result['nom'] ?></td>
                            ...
                            <td><?=
                                ...
                                <a href = "produitPage.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> >listes Produits</a>
