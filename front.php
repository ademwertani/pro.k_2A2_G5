                            ...
                            <div class="col-md-6">
                                <div class="main-menu">
                                    <ul>
                                        ...
                                        <li><a href="évenement.html">évenement</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                <h2>évenement Us</h2>
                                <span><a href="index.html">Home </a> / <a href="recipes.html">Recipes</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row" id="Container">
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item drink">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="drink.html">making drinks</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item kitchen">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="kitchen.html">Equipment</a></h3>
