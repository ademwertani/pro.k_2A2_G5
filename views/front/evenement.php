...
-->
    <head>
        <meta charset="utf-8">
        <title>évenement - Grill Template</title>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                <h2>évenement Us</h2>
                                <span><a href="">Home </a> / <a href="recipes.html">Recipes</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="filters col-md-12 col-xs-12">
                            <ul id="filters" class="clearfix">
                                ...
                                <li><span class="filter" data-filter=".cooking">Cooking</span></li>
                                <li><span class="filter" data-filter=".kitchen">kitchen equipment</span></li>
                                <li><span class="filter" data-filter=".recipes">the recipes</span></li>
                                <li><span class="filter" data-filter=".drink">Drinks</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="row" id="Container">
                        <div class="col-md-3 col-sm-6 mix portfolio-item cooking">       
                            <div class="portfolio-wrapper">                
                                <div class="portfolio-thumb">
                                    <img src="images/product1.jpg" alt="" />
                                    <div class="hover">
                                        <div class="hover-iner">
                                            <a class="fancybox" href="images/product1.jpg"><img src="images/open-icon.png" alt="" /></a>
                                            <span>02/02/2022</span>
                                        </div>
                                    </div>
                                </div>  
                                <div class="label-text">
                                    <h3><a href="cooking.php">cooking</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item drink">       
                            <div class="portfolio-wrapper">                
                                <div class="portfolio-thumb">
                                    ...
                                    <div class="hover">
                                        <div class="hover-iner">
                                            <a class="fancybox" href="images/product2.jpg"><img src="images/open-icon.png" alt="" /></a>
                                            <span>03/03/2022</span>
                                        </div>
                                    </div>
                                </div>  
                                <div class="label-text">
                                    <h3><a href="drink.php">making drinks</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item kitchen">       
                            <div class="portfolio-wrapper">                
                                <div class="portfolio-thumb">
                                    <img src="images/product3.jpg" alt="" />
                                    <div class="hover">
                                        <div class="hover-iner">
                                            <a class="fancybox" href="images/product3.jpg"><img src="images/open-icon.png" alt="" /></a>
                                            <span>04/04/2022</span>
                                        </div>
                                    </div>
                                </div>  
                                <div class="label-text">
                                    <h3><a href="kitchen.php">Equipment</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item recipes">       
                            <div class="portfolio-wrapper">                
                                <div class="portfolio-thumb">
                                    <img src="images/product4.jpg" alt="" />
                                    <div class="hover">
                                        <div class="hover-iner">
                                            <a class="fancybox" href="images/product4.jpg"><img src="images/open-icon.png" alt="" /></a>
                                            <span>05/05/2022</span>
                                        </div>
                                    </div>
                                </div>  
                                <div class="label-text">
                                    <h3><a href="recipess.php">RECIPES</a></h3>
                ...
                <div class="container">
                    ...
                    <div class="main-footer">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="évenement">
                                    <h4 class="footer-title">évenement Grill</h4>
