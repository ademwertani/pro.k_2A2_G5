                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                <h2>Types :</h2>
                                <span> <a href="cooking.php">1</a> / <a href="kitchen.php">2</a>/ <a href="recipess.php">3</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="product-item col-md-12">
                                    <div class="row">
                                        <div class="col-md-8">  
                                                ...
                                                <a href="kitchenaff.php">Afficher le contenu des evenements evenement</a> 
                                                <label for="placeE">
                                                    <form action="setcooking.php" method="POST">
                                                    
                                                        <label for="idE">
                                                            Entrez l'id d'evenement que vous voulez rejoindre:
                                                            <input type="text" name="idE" id="idE">
                                                        </label>
                                                        <label for="adresseE">
                                                            taper votre adresse:
                                                            <input type="text" name="adresseE" id="adresseE">
                                                        </label>
