            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="heading-content">
                        ...
                        <span> <a href="index.html"></a> / <a href="single-post.html">Single Post</a></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div id="single-blog" class="page-section first-section">
                <div class="container">
                    ...
                    $result=$mysqli->query("select * from categorie where idid='".$row['id_categorie']."");
                    while($row=$result->fetch_assoc()){
                    $query  =$mysqli->query("select * from recette where id='".$row['id_produit']."'");
                        ...
                        <div class="view-comments">
                            <div class="comments">
                                ...
                                <div class="comment-body">
                                    ...
                                    <p>Nulla ac elementum nibh. Interdum et malesuada fames ac ante ipsum primis in
                                        faucibus. Aliquam erat volutpat. Donec rhoncus quam sit amet sodales finibus.
                                        Donec pellentesque non massa eu maximus. In non tellus id sem tempor gravida.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="replyed-form">
                            <div class="comments replyed">
                                ...
                                <div class="comment-body">
                                    ...
                                    <a href="#" class="hidden-xs">Reply</a>
                                    <p>In pulvinar venenatis odio. Sed in ex sit amet ipsum posuere mollis. Nam nec
                                        risus feugiat dui ultrices dignissim. Morbi ex purus, commodo a tristique eu,
                                        mollis a nisi. Pellentesque in enim sit amet tellus ornare fringilla eget eu
                                        arcu.</p>
                                </div>
                            </div>
                        </div>
                        <div class="view-comments">
                            <div class="comments">
                                ...
                                <div class="comment-body">
                                    ...
                                    <a href="#" class="hidden-xs">Reply</a>
                                    <p>Duis rutrum, libero eu blandit gravida, massa orci cursus nisi, vehicula
                                        facilisis purus neque dignissim urna. Etiam molestie elementum elit at tempus.
                                        Suspendisse quis consectetur nisi, vitae consequat sem. In et quam id libero
                                        venenatis venenatis. Morbi vitae justo vulputate, auctor augue eu, pulvinar
                                        augue.</p>
                                </div>
                            </div>
                        </div>
                        <div class="view-comments">
                            <div class="comments">
                                ...
                                <div class="comment-body">
                                    ...
                                    <a href="#" class="hidden-xs">Reply</a>
                                    <p>Suspendisse vitae maximus nisl, non finibus ante. Suspendisse neque nisl, luctus
                                        ullamcorper erat a, fermentum mollis nibh. Aliquam vulputate augue vel metus
                                        suscipit euismod. Quisque id purus massa. Sed condimentum facilisis eros,
                                        ultrices tincidunt libero facilisis eget. Integer eget cursus velit.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="about">
                            ...
                            <p>Grill is free HTML5 template by <span class="blue">template</span><span
                                    class="green">mo</span> and it is a free responsive bootstrap layout that can be
                                applied for any purpose.
                                <br><br>Credit goes to <a rel="nofollow" href="http://unsplash.com">Unsplash</a> for
                                photos used in this template. Nam commodo erat quis ligula placerat viverra.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="more-info">
                            ...
                            <p>Sed dignissim, diam id molestie faucibus, purus nisl pretium quam, in pulvinar velit
                                massa id elit.</p>
                            <ul>
